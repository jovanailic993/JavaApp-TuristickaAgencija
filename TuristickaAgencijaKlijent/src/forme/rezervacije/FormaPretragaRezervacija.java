...
import kontroler.rezervacije.KontrolerPretrageRezervacija;
...
public class FormaPretragaRezervacija extends javax.swing.JDialog {
    KontrolerPretrageRezervacija kontroler;
    /**
     * Creates new form FormaPretragaRezervacija
     */
    public FormaPretragaRezervacija(java.awt.Frame parent, boolean modal, String tipOperacije) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        
        kontroler = new KontrolerPretrageRezervacija();
    ...
    private void jbtnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnDetaljiActionPerformed
        kontroler.prikaziRezervacije(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormaPretragaRezervacija.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormaPretragaRezervacija dialog = new FormaPretragaRezervacija(new javax.swing.JFrame(), true,"");
